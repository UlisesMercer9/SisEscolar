    ...
    <img src="img/empresa.png" alt="" class="circle responsive-img" height="100" width="100">  
     ...
     <ul class="collapsible collapsible-accordion">
       ...
       <div class="fixed-action-btn">
         <a class="btn-floating btn-large blue tooltipped"  data-position="left" data-tooltip="Agregar nueva aula de clases" href="{!!URL::to('/aulas/create')!!}">
       ...
       <table class="col l10 offset-l1 centered highlight responsive-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> 
               {!!link_to_route('aulas.edit', $title = '', $parameters = $aula->id, $attributes = ['class'=>'amber-text fa fa-pencil fa-2x tooltipped', 'data-position'=>'left','data-delay'=>'50', 'data-tooltip'=>'Actualizar la información del aula'])!!}

              <a href="{{ route('aulas.destroy', $aula->id) }}" onclick="return confirm('¿Seguro que deseas eliminar la información del aula?')" class="red-text fa fa-trash-o fa-2x tooltipped" data-position="left" data-delay="50" data-tooltip="Eliminar la información del aula"></a>
