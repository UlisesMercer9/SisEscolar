       ...
       <table class="col l10 offset-l1 centered highlight responsive-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> 
               {!!link_to_route('periodos.edit', $title = '', $parameters = $periodo->id, $attributes = ['class'=>'amber-text fa fa-pencil fa-2x tooltipped', 'data-position'=>'left','data-delay'=>'50', 'data-tooltip'=>'Actualizar la información del aula'])!!}

              <a href="{{ route('periodos.destroy', $periodo->id) }}" onclick="return confirm('¿Seguro que deseas eliminar la información del aula?')" class="red-text fa fa-trash-o fa-2x tooltipped" data-position="left" data-delay="50" data-tooltip="Eliminar la información del aula"></a>
